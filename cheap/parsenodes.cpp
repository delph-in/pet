...
void ParseNodes::initialize() {
  ...
  _label_path = path_to_lpath(cheap_settings->value("pn-label-path"));

  _prefix_path = path_to_lpath(cheap_settings->value("pn-prefix-path"));
  _suffix_path = path_to_lpath(cheap_settings->value("pn-suffix-path"));

  _recursive_path = path_to_lpath(cheap_settings->value("pn-recursive-path"));
  _local_path = path_to_lpath(cheap_settings->value("pn-local-path"));
  _label_fs_path = path_to_lpath(cheap_settings->value("pn-label-fs-path"));
  ...
  _label_type = lookup_type(cheap_settings->value("pn-label-type"));
  _meta_type = lookup_type(cheap_settings->value("pn-meta-type"));
